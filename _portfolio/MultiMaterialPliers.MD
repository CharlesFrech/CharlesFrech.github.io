...
Replace `"gif1.gif"` and `"gif2.gif"` with the actual file paths or URLs of your GIF images. This code will horizontally center both GIFs within the `.container` div.
